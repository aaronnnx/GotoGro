...
<body>
  ...
  <center>
      <?php
        ...
        $query = "SELECT item_name FROM item where item_id = '$id'";
        $results = mysqli_query($mysqli,$query);

        while($row = mysqli_fetch_array($results))
        {
          $emp_name = $row['item_name'];
        }
      ?>
      ...
      <?php
        ...
        while($row = mysqli_fetch_array($results))
        {
          ...
          echo '<a href="searchGroceryItemViewGroceryItemSupervisor.php">Click here to the view item details again.</a> </center>';
      ?>
