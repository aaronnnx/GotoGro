  ...
  <body>
    ...
    <?php
            ...
            if ($insertQuery != NULL)
            {
              ...
              echo '<br><br> <center> <a href="addSalesRecordSupervisorClient1.php">Click here to add a new sales record.</a> <br><br>';
              echo '<a href="addSalesRecordSupervisorClient2.php">Click here to add more items of this sales record.</a> </center>';
