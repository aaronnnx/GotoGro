...
<body>
  ...
  <center>
    <div class="topics">
      <h2> Edit Grocery Item Search </h2>
      <h3> ➔ Please copy the item id of the selected item to edit item application. </h3>
      ...
      <?php
        ...
        echo "<table>
                <tr>
                  ...
                  <td style='width:500px'> <strong> Click to edit grocery item details </strong> </td>
                </tr>
              </table>";
        ...
        if ($results != NULL)
        {
          while($row = mysqli_fetch_array($results))
          {
            ...
            echo "
              <form action='editGroceryItemSupervisor.php' method='post'>
                <table>
                <tr>
