...
<body>
  ...
  <?php
        ...
        else if ($updateResult == 1)
        {
          ...
          <br><br> <center> <a href="managerHomepage.php">Click here to the homepage</a> <br><br>
          <a href="searchSalesRecordEditSalesRecordManager.php">Click here to the edit sales record details again.</a> </center>
