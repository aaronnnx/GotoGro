      ...
      if(isset($_POST['add']))
      {
        ...
        else
        {
           ...
           VALUES ('$id', '$name', '$ic', '$number', '$address')");
            ...
            if($query)
            {
             echo "<center> <h2> Member added successfully. </h2> </center><br>";
       ...
       echo '<br><br> <center> <a href="staffHomepage.php">Click here to the homepage</a> <br><br>';
       echo '<a href="addMemberStaff.php">Click here to the add member again.</a> </center>';
