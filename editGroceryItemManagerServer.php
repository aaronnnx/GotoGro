  ...
  <?php
      ...
      $quantity = $_POST['item_quantity'];
        ...
        else if ($updateResult == 1)
        {
          ...
          $viewQuery = mysqli_query($mysqli, "SELECT * FROM item WHERE item_id = '$id'");
          ...
          echo '<a href="searchGroceryItemEditGroceryItemManager.php">Click here to the edit item details again.</a> </center>';
        }
    ?>
</body>
</html>
